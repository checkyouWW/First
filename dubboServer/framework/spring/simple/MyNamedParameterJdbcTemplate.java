 ...
 */
public class MyNamedParameterJdbcTemplate implements NamedParameterJdbcOperations {
	...
	public MyNamedParameterJdbcTemplate(DataSource dataSource) {
		...
		this.classicJdbcTemplate = new MyJdbcTemplate(dataSource);
	}
	...
	public Map queryForMap(String sql, SqlParameterSource paramSource) throws DataAccessException {
		return (Map) queryForObject(sql, paramSource, new MyColumnMapRowMapper());
	}

	public Map queryForMap(String sql, Map paramMap) throws DataAccessException {
		return (Map) queryForObject(sql, paramMap, new MyColumnMapRowMapper());
	}
	...
	public List queryForList(String sql, SqlParameterSource paramSource) throws DataAccessException {
		return query(sql, paramSource, new MyColumnMapRowMapper());
	}
	...
	public int[] batchUpdate(String s, Map amap[]){
		int[] arr = {};
		return arr;
	}

    public int[] batchUpdate(String s, SqlParameterSource asqlparametersource[]){
    	int[] arr = {};
		return arr;
    }
